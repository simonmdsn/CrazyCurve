...
public class SettingsState extends State {
    ...
    private ImageButton createQuitButton() {
        final Texture quitButtonTexture = getGame().getAssets().getAssetManager().get("textures/settingsstate/quit button.png");
    ...
    private ImageButton createBackButton() {
        final Texture backButtonTexture = getGame().getAssets().getAssetManager().get("textures/settingsstate/back button.png"); //TODO Back image.
